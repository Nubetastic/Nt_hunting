...
Config.AnimalList = {
    ...
    [1110710183]  = { name = "Deer", givenItem = { "h_medium_pelt", "h_meat_game", "h_animal_heart" }, givenAmount = { 1, {2, 2, 3}, 1 } },
    ...
    [-564099192]  = { name = "Whooping Crane", givenItem = { "h_feather", "h_meat_bird" }, givenAmount = { {1, 2, 3}, 1 } },
    ...
    [723190474]   = { name = "Canada Goose", givenItem = { "h_feather", "h_meat_bird", "h_animal_fat" }, givenAmount = { {1, 2, 3}, 1, {0, 1, 2} } },
    [-2145890973] = { name = "Ferruinous Hawk", givenItem = { "h_feather", "h_meat_bird" }, givenAmount = { {1, 2, 3}, 1 } },
    [1095117488]  = { name = "Great Blue Heron", givenItem = { "h_feather", "h_meat_bird" }, givenAmount = { {1, 2, 3}, 1 } },
    ...
    [386506078]   = { name = "Common Loon", givenItem = { "h_feather", "h_meat_bird" }, givenAmount = { {1, 2, 3}, 1 } },
    ...
    [-86244272]   = { name = "Great Horned Owl", givenItem = { "h_feather", "h_meat_bird" }, givenAmount = { {1, 2, 3}, 1 } },
    ...
    [730092646]   = { name = "American Black Bear", givenItem = { "h_large_pelt", "h_meat_big_game", "h_animal_heart", "h_animal_fat", "h_animal_trophy" }, givenAmount = { 1, {2, 2, 3}, 1, {2, 2, 3} , 1 } }
}
