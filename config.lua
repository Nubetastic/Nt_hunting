...
Config.AnimalList = {
    ...
    [-1550768676] = { name = "Chipmunk", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [1582986780] = { name = "Blue Jay", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [1784941179] = { name = "Cardinal", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [-292997097] = { name = "Cedar waxwing", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [-2037578922] = { name = "Cuban Crab", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [-1763055991] = { name = "Crawfish", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [98537260] = { name = "Crow", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [-930822792] = { name = "Bull Frog", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [-1302821723] = { name = "Hooded Oriole", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [111281960] = { name = "Pigeon", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [674267496] = { name = "Bat", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [-1210546580] = { name = "Robin", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [-1910795227] = { name = "Songbird", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [-1028170431] = { name = "Sparrow", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [1502581273] = { name = "Toad", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [510312109] = { name = "Red-bellied Woodpecker", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [729471181] = { name = "Pileate Woodpecker", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
    [1465438313] = { name = "Grey Squirrel", givenItem = { "h_small_animal" }, givenAmount = { 1 } },
