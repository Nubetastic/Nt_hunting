...
Config.AnimalList = {
    ...
    [-22968827]   = { name = "Water Snake", givenItem = { "h_reptile_skin", "h_meat_reptile" }, givenAmount = { 1, {1, 1, 2} } },
    [-229688157]  = { name = "CottonMouth Water Snake", givenItem = { "h_reptile_skin", "h_meat_reptile" }, givenAmount = { 1, {1, 1, 2} } },
    [-1790499186] = { name = "Snake Red Boa", givenItem = { "h_reptile_skin", "h_meat_reptile" }, givenAmount = { 1, {1, 1, 2} } },
    [1464167925]  = { name = "Snake Fer-De-Lance", givenItem = { "h_reptile_skin", "h_meat_reptile" }, givenAmount = { 1, {1, 1, 2} } },
    [846659001]   = { name = "Black-Tailed Rattlesnake", givenItem = { "h_reptile_skin", "h_meat_reptile" }, givenAmount = { 1, {1, 1, 2} } },
    [545068538]   = { name = "Western Rattlesnake", givenItem = { "h_reptile_skin", "h_meat_reptile" }, givenAmount = { 1, {1, 1, 2} } },
    [-1854059305] = { name = "Green Iguana", givenItem = { "h_reptile_skin", "h_meat_reptile" }, givenAmount = { 1, {1, 1, 2} } },
    ...
    -- Medium Game Meat
    [1755643085]  = { name = "American Pronghorn Doe", givenItem = { "h_medium_pelt", "h_meat_game", "h_animal_heart" }, givenAmount = { 1, {2, 2, 3}, 1 } },
    [-1568716381] = { name = "Big Horn Ram", givenItem = { "h_medium_pelt", "h_meat_game", "h_animal_heart", "h_animal_trophy" }, givenAmount = { 1, {2, 2, 3}, 1, 1 } },
    [-1963605336] = { name = "Buck", givenItem = { "h_medium_pelt", "h_meat_game", "h_animal_heart", "h_animal_trophy" }, givenAmount = { 1, {2, 2, 3}, 1, 1 } },
    [252669332]   = { name = "American Red Fox", givenItem = { "h_medium_pelt", "h_meat_game", "h_animal_heart" }, givenAmount = { 1, {2, 2, 3}, 1 } },
    [-1143398950] = { name = "Big Grey Wolf", givenItem = { "h_medium_pelt", "h_meat_game", "h_animal_heart", "h_animal_trophy" }, givenAmount = { 1, {2, 2, 3}, 1, 1 } },
    [-885451903]  = { name = "Medium Grey Wolf", givenItem = { "h_medium_pelt", "h_meat_game", "h_animal_heart", "h_animal_trophy" }, givenAmount = { 1, {2, 2, 3}, 1, 1 } },
    [-829273561]  = { name = "Small Grey Wolf", givenItem = { "h_medium_pelt", "h_meat_game", "h_animal_trophy" }, givenAmount = { 1, {2, 2, 3}, 1 } },
    [480688259]   = { name = "Coyote", givenItem = { "h_medium_pelt", "h_meat_game", "h_animal_heart" }, givenAmount = { 1, {2, 2, 3}, 1 } },
    [1654513481]  = { name = "Panther", givenItem = { "h_medium_pelt", "h_meat_game", "h_animal_heart", "h_animal_trophy" }, givenAmount = { 1, {2, 2, 3}, 1, 1 } },
    [-753902995]  = { name = "Alpine Goat", givenItem = { "h_medium_pelt", "h_meat_game", "h_animal_heart" }, givenAmount = { 1, {2, 2, 3}, 1 } },
    ...
    [1556473961]  = { name = "Bison", givenItem = { "h_large_pelt", "h_meat_big_game", "h_animal_heart", "h_animal_trophy" }, givenAmount = { 1, {4, 4, 6}, 1, 1 } },
    [367637652]   = { name = "Bison", givenItem = { "h_large_pelt", "h_meat_big_game", "h_animal_heart", "h_animal_trophy" }, givenAmount = { 1, {4, 4, 6}, 1, 1 } },
    [1957001316]  = { name = "Bull", givenItem = { "h_large_pelt", "h_meat_big_game", "h_animal_heart", "h_animal_trophy" }, givenAmount = { 1, {5, 5, 5}, 1, 1 } },
